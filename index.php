...
<section class="banner" role="banner">
  ...
  <!-- Display within the slider(Text) --> 
    <div class="banner" id="banner"> 
	<div class="slider-banner">
            <div data-lazy-background="edenimg/sliders/slider1.jpg"> 
            ...
            <div data-lazy-background="edenimg/sliders/slider2.jpg"> 
...
<!-- SLIDER section -->
<section id="intro " class="section intro bg-danger">
  <div class="container">
    <div class="col-md-8 col-md-offset-2 text-center ">
      <h3>WELCOME TO EDEN DENTAL CLINIC NAROK.</h3>
      <p>Let Your Smile Change The World!</p>
	<div class="site-info ">
		<div class="phoneInfo bg-danger "><h6>Call Now: </h6><a href="#">0725213809</div>
		<div class="timeInfo bg-success"><h5>Opening Hours: </h5> <em>MONDAY: 8AM - 6PM, TUESDAY: 8AM - 6PM, WEDNESDAY: 8AM - 6PM, THURSDAY: 8AM - 6PM,
		FRIDAY: 8AM - 6PM, SATURDAY: 8AM - 3PM
		</em></div>
	</div>   
   </div>
  </div>
    ...
    <div class="container">
         ...
         <div class="col-md-3">
                <div class="table">
                    ...
                    <p class="editContent">per specific</p>
                    <ul class="table-content">
                        <li class="editContent"><i class="fa fa-hdd-o"></i> 10 GB Storage</li>
                        <li class="editContent"><i class="fa fa-pie-chart"></i> 500 GB Bandwidth</li>
                        <li class="editContent"><i class="fa fa-envelope-o"></i> Email Support</li>
